...
var SFW = ["Archie eating a feather", "Pixel scared of Archie", "Boating on Sydney harbour", "Game nights that end at 4am", "Caprioska cocktails", "Gladys Berejiklian", "Week 3 of Lockdown", "Rose's dice game", "Andrea losing at Caveman", "Protik cooking on the firepit", "Nick not wearing a shirt", "A Pro-Rose-Nick-Andrea adventure", "Berowa Waters", "Long Jetty", "Scott Morrisson in Hawaii", "hot people", "balanced breakfast", "raptor attacks", "Pixel being a fat cat", "Bondi during lockdown", "Tin foil hat", "Nick interviewing for a job", "Horse people", "Pro and Nick go suit shopping", "overcompensation", "Pro proposing to rose", "Bagpipe man playing the Titanic song", "the great depression", "partying with the cat", "god", "partying with Archie", "BATMAN!!!", "finger painting", "Cheese from Gouda", "bees?", "true meaning of christmas", "free samples", "not wearing pants", "a really cool hat", "the three horsemen of the apocalypse", "crippling debt", "laying an egg", "five-dollar footlongs", "my relationship status", "drinking alone", "mime having a stroke", "puppies!", "child beauty pageants", "the south", "destroying the evidence", "the amish", "inner demons", "old-people smell", "fear itself.", "unlimited shrimp", "bucket of fish heads", "giving 110%", "kanye west", "self-loathing", "vaping with friends", "natural selection", "demonic possession", "disco fever", "the entire internet", "space jam on vhs", "a toxic family", "eating an entire snowman", "pikachu", "Australia", "nascar", "falcon punch!", "drunk text", "Nick's dad making a BBQ", "black hole", "a bushy mustache", "cheap motel", "public restrooms", "Movember", "stealing wheelchairs", "stepping in gum", "hoarders", "bedbugs", "gravity gun", "reading the comments", "Mitsubishi Lancer", "achievement unlocked", "taco cat", "pebbles", "laundry night", "don't eat the cookies", "pretending to read", "lady ghost", "impaled with stars", "candyman", "Protik being lucky in games", "where missing socks go", "eggmobile", "female james bond", "imaginary friend", "mortality", "an alliance in monopoly", "In hospital on NYE", "new underwear", "pizza cat house gun", "space chef", "fairy tale", "geese", "emo duck", "humidity", "nervous dinosaur", "pizza pac man", "cuddly bat", "Nick getting angry during a game", "afternoon coffee", "lonely plumber", "north of the wall", "Nick falling off a bike"];
